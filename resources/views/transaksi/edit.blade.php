        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{url('transaksi/update/'.$data->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" name="tanggal" required class="form-control" placeholder="Contoh : Wallpaper dinding stiker" value="{{$data->tanggal}}">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                       ...
                       <select class="form-control" name="tipe" required>
                         ...
                         <option value="in" {{$materialStock->tipe == 'in'?'selected':''}}>
                            Pembelian
                         </option>
                         <option value="out" {{$materialStock->tipe == 'out'?'selected':''}}>
                            Penjualan
                         </option>
                       </select>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                          <td>
                            @if(in_array($item->id,$materialSelected))
                              <input type="checkbox" name="material_id[{{$item->id}}]" value="{{$item->id}}" checked>
                            @else
